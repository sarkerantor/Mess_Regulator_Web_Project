        ...
        <div class="text-center">
            ...
            <div class="mb-3">
                ...
                <p class="text-muted mb-3">
                    Generate new monthly transaction table for upcoming month.
                </p>
            </div>

            <a href="initialize.php" 
            class="btn btn-warning btn-lg px-5 rounded-pill shadow-sm next-btn">
                <i class="bi bi-arrow-right-circle me-2"></i>
                Create Next Month Transaction
            </a>
